...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //String path = "D:/Unity";
        String path = "/Users/vitalya/Documents/6sem/tpo/TPO/6lab/src/Io/test.txt";
    ...
    private static void analyzeAndWriteToFile(File directory) {
        try {
            File outputFile = new File("/Users/vitalya/Documents/6sem/tpo/TPO/6lab/src/Io/test.txt");
